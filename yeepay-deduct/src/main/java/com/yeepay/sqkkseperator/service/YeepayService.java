...
import com.yeepay.sqkkseperator.config.test;
...
public class YeepayService {
	...
	static String secretKey= 	 new test().getvalue("isv_private_key");
	static String serverRoot=		Config.getInstance().getValue("serverRoot");

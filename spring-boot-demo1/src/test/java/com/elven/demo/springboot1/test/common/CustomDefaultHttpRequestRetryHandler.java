 ...
 * @since 4.0
 */
public class CustomDefaultHttpRequestRetryHandler implements HttpRequestRetryHandler {

    public static final org.apache.http.impl.client.DefaultHttpRequestRetryHandler INSTANCE = new org.apache.http.impl.client.DefaultHttpRequestRetryHandler();
     ...
     * @since 4.3
     */
    public CustomDefaultHttpRequestRetryHandler(

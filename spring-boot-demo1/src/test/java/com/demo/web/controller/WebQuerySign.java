...
import com.demo.web.domain.request.TradeQueryEntity;
import com.demo.web.domain.request.TradeQueryReqDto;
import com.demo.web.domain.response.BaseResponseDto;
import com.demo.web.domain.response.QueryResultTradeEntity;
...
public class WebQuerySign {
    ...
    @Test
    public void test5(){
        Date transDateTime = new DateTime().toDate();
        Date expireDateTime = new DateTime().plusMinutes(60).toDate();

        System.out.println(transDateTime);
        System.out.println(expireDateTime);
        System.out.println(transDateTime.compareTo(expireDateTime));
    }
}